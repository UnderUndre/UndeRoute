# 🌐 Business Plan: [PRODUCT / AGENCY NAME]

**Version:** [X.Y] ([one-line edition subtitle])  
**Date:** [YYYY-MM-DD]  
**Brand:** `[brand]` (`domain`)  
**Status:** **[Pre-revenue | Phase A | …] — honest traction: [N] closed deals / [N] paying users.**  
**Language:** [RU/EN — stakeholder-readable]

> **Hard law (if any):** [e.g. sole Phase A SKU, freeze secondary brand until cash gate]. Violation = focus reset.
...
## 📣 2b. GTM spine (sales/marketing — not a full media plan)
